...
var generate = function () 
{
    ...
    {
        alert("Error! Choose a number between 2 to 100.");
        $("total_fib").value = ""; //blanks out the DOM input box
    }
else
{
    ...
    {
        k = i+j;
        stringOutput = stringOutput + k + " "; //this outputs O 1 + the value of k + the next set of numbers based on the loop
        i = j;
        j = k;
